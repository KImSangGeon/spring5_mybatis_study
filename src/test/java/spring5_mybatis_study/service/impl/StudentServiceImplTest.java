...
public class StudentServiceImplTest {
	...
	private static final  Log log = LogFactory.getLog(StudentServiceImplTest.class);	
	...
	@Test
	public void testSelectStudentAllForMap() {
		log.debug(Thread.currentThread().getStackTrace()[1].getMethodName() + "()");
		
		Map<Integer, Student> map = service.selectStudentAllForMap();
		Assert.assertNotNull(map);
